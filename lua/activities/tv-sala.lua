...
function activity.netflix()
   devices.lg.on_cursorvisible(function()
         --devices.lg.cursorvisible(true)
         devices.lg.touchclick()
         schedule(2, 0, 0, function()
                     devices.lg.touchmove(-1920, -1080)
                     devices.lg.touchmove(900, 250)
                     --devices.lg.touchclick()
                     schedule(1, 0, 0, function()
                                 devices.lg.touchclick()
                                 devices.lg.touchmove(1920, 1080)
                     --devices.lg.cursorvisible(false)
                     --             devices.lg.touchclick()
                     --             devices.lg.cursorvisible(false)
                     end)
         end)
